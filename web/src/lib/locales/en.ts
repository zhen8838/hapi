export default {
  ...
  'newSession.profile': 'Session Profile',
  'newSession.profile.none': 'No profile',
  'newSession.profile.help': 'Profiles are stored locally in browser storage and can be reused on this machine.',
  'newSession.profile.saveAsNew': 'Save as new',
  'newSession.profile.update': 'Update profile',
  'newSession.profile.delete': 'Delete',
  ...
  'newSession.additionalParameters': 'Additional Parameters',
  'newSession.additionalParameters.help': 'Claude Code only. Enter one CLI argument per item.',
  'newSession.additionalParameters.add': 'Add',
  ...
  'notification.title': 'Session alerts',
  'notification.description': 'Get notified when a session is ready for input.',
  'notification.button': 'Enable',
  'notification.enabling': 'Enabling…',
  'notification.readyTitle': 'Ready for input',
  'notification.readyBody': 'A session is waiting for your command.',
  ...
  'settings.notifications.sessionAlerts': 'Session Alerts',
