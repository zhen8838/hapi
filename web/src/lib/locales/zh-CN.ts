export default {
  ...
  'newSession.agent': '代理',
  'newSession.profile': '会话配置',
  'newSession.profile.none': '不使用配置',
  'newSession.profile.help': '配置会保存在当前浏览器本地存储中，可在这台机器上重复使用。',
  'newSession.profile.saveAsNew': '另存为新配置',
  'newSession.profile.update': '更新配置',
  'newSession.profile.delete': '删除配置',
  ...
  'newSession.additionalParameters': '附加参数',
  'newSession.additionalParameters.help': '目前仅对 Claude Code 生效。每一项填写一个 CLI 参数。',
  'newSession.additionalParameters.add': '添加',
  ...
  'install.button': '安装',
  'notification.title': '会话提醒',
  'notification.description': '当会话可以继续输入时接收提醒。',
  'notification.button': '开启',
  'notification.enabling': '开启中…',
  'notification.readyTitle': '等待输入',
  'notification.readyBody': '有会话正在等待你的指令。',
  ...
  'settings.notifications.sessionAlerts': '会话提醒',
  'settings.notifications.enabled': '已开启',
  'settings.notifications.off': '关闭',
  'settings.notifications.blocked': '已阻止',
  'settings.notifications.unavailable': '不可用',
  'settings.notifications.enable': '开启',
